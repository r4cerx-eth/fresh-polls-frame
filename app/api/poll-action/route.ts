...
export async function POST(req: Request) {
  try {
    ...
    if (alreadyVoted) {
      ...
      const messageUrl = "https://placehold.co/1200x630/white/black/png?text=The+only+people+who+really%0Acare+about+you,%0Aare+the+ones+next%0Ato+you%0A&fontsize=32";
